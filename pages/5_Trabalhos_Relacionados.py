...
st.markdown("""
A literatura recente aborda os impactos da IA Generativa a partir de diferentes prismas metodológicos e econômicos. O quadro abaixo sintetiza as principais referências discutidas no artigo:
""")
...
Enquanto os trabalhos da literatura focam em eixos isolados (seja o mercado brasileiro, regulação ou métricas de ocupação), este artigo **integra essas diferentes perspectivas** por meio de uma análise comparativa e de uma matriz SWOT unificada.
""")
